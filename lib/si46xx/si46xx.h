...
#define CMD_BUFFER_LENGTH 40	// 40 byte command buffer - this must be evenly divisible by 4
...
#define CMD_HOST_LOAD_ARG_IMAGE_DATA0_INDEX	4 //start of the actual host load data
...
void si46xx_init_dab_from_flash(void);
